...
def generate_pdf_and_upload(bundle: dict) -> dict:
    ...
    c.drawString(72, 750, "CyberJoule – Exploratory Analysis")
    c.drawString(72, 730, f"Instance: {instance_id}")
    c.drawString(72, 710, f"Events: {bundle.get('eda', {}).get('total_events', 0)}")
    c.drawString(72, 690, f"Anomalies: {len(bundle.get('anomalies', {}).get('anomalies', []))}")
    c.showPage()
    c.save()
    ...
    return {"blob_path": blob_path, "download_url": f"blob://{blob_path}"}
